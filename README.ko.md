...
<img src="assets/settings-pinned-apps.jpg" width="878" alt="StayTab 고정 앱 설정">
...
StayTab은 호환성을 위해 BetterCmdTab의 고급 전환 엔진을 유지해요. 프로필, 브라우저 탭, 창 레이아웃, 검색, 세부 패널 제어는 핵심 기능이 아닌 고급 사용자 기능으로 구분해요. 기준은 [제품 범위](docs/PRODUCT.md)에서 확인할 수 있어요.
...
StayTab은 전환 단축키를 확인하고 선택한 창에 포커스를 주기 위해 손쉬운 사용 권한을 사용해요. 브라우저 탭 전환은 사용하는 브라우저와 기능에 따라 자동화 또는 전체 디스크 접근 권한을 추가로 요청할 수 있어요.
