...
/// `~/.config/staytab/config.json`. Reading also accepts the legacy
...
extension Preferences {
    ...
    enum SettingsImportError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .malformed:
                return String(localized: "This file isn't a valid StayTab settings export.")
            case .unsupportedVersion(let v):
                return String(localized: "This settings file uses a newer format (version \(v)) than this version of StayTab can read. Update the app and try again.")
            }
        }
    }
    ...
    nonisolated static func settingsSchema(for values: [String: Any], version: String) -> [String: Any] {
        ...
        return [
            ...
            "title": "StayTab configuration",
            "description": "Generated by StayTab \(version). Keys mirror the Switcher.* preferences (prefix stripped); unknown keys are ignored, absent keys keep their current value.",
            "type": "object",
